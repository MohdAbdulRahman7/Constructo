...
if(isset($_POST["add_to_cart"]))
{
    if(isset($_SESSION["shopping_cart"]))
    {
        ...
        else
        {
            ...
            echo '<script>window.location="landscape.php"</script>';
...
body
{
	background-image: url(lback3.jpg);
...
<h1 class="header" style="margin-top: -50px; margin-left: 50px;color: #fff; ">Construct A Landscape</h1>

<div class="main">
    <img src="roads.jpg" width="1250" height="500" style="margin-left: 50px;">
</div> 
...
<div class="container" style=" margin:50px;" >
        <?php
            $query = "SELECT * FROM `landscape` where type='hm' ";
    ...
    $result = mysqli_query($con,$query);
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-4" >
                     ...
                     <form method="post" action="landscape.php?action=add&id=<?php echo $row["id"]; ?>">
...
<div style="clear:both "></div>
            ...
            <div class="table-responsive" style="color: #fff;">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td><a href="landscape.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>
                    </tr>
                    <?php
        ...
        <div class="button" style="float: right;
                                ...
                                ">
            <a href="checkout.html" style="color: #000; text-decoration: none;"><i class="fas fa-shopping-cart"></i>  Checkout</a>
        </div>    
