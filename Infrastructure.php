...
if(isset($_POST["add_to_cart"]))
{
    if(isset($_SESSION["shopping_cart"]))
    {
        ...
        else
        {
            ...
            echo '<script>window.location="Infrastructure.php"</script>';
...
<h1 class="header" style="margin-top: -50px; margin-left: 50px;color: #fff; font-size: 30px; ">Construct A Infrastructure</h1>

<div class="main">
    <img src="landscape.jpg" width="1250" height="500" style="margin-left: 50px;">
</div> 
...
<div class="container" style=" margin:50px;" >
        <?php
            $query = "SELECT * FROM `infrastructure` where type='hm' ";
    ...
    $result = mysqli_query($con,$query);
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-4">
                     ...
                     <form method="post" action="Infrastructure.php?action=add&id=<?php echo $row["id"]; ?>">
...
<div class="container" style=" margin:50px;" >
        <?php
            $query = "SELECT * FROM `infrastructure` where type='cm' ";
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td><a href="Infrastructure.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>
                    </tr>
                    <?php
